const fs = require('fs');
let content = fs.readFileSync('d:/MY PROJECTS/my-dldl-web/app/admin/add/page.tsx', 'utf8');
...
fs.writeFileSync('d:/MY PROJECTS/my-dldl-web/app/admin/add/page.tsx', content, 'utf8');
console.log('Done Add Page');
