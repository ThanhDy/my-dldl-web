...
import { FaUser, FaSkull, FaGem, FaGhost, FaMagic, FaDiscord, FaComments } from "react-icons/fa"; // Thêm FaComments
import { GiMagicPortal } from "react-icons/gi";

const features = [
  { title: "Hồn Sư", icon: <FaUser size={24} />, href: "/soul-masters", active: true },
  { title: "Ám Khí", icon: <FaSkull size={24} />, href: "/hidden-weapons", active: false },
  { title: "Thần Khí", icon: <FaGem size={24} />, href: "/divine-weapons", active: false },
  { title: "Hồn Hoàn Riêng", icon: <FaMagic size={24} />, href: "/god-rings", active: false },
  { title: "Hồn Linh", icon: <FaGhost size={24} />, href: "/soul-spirits", active: false },
  { title: "Hồn Hoàn Hung Thú", icon: <GiMagicPortal size={24} />, href: "/general-rings", active: false },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-800 via-slate-950 to-black text-white p-6 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-6xl w-full px-4 mb-10">
        {features.map((feature, index) =>
          feature.active ? (
            ...
            <div key={index} className="relative bg-slate-900/40 border border-slate-800/50 p-4 rounded-xl flex flex-col items-center text-center gap-2 opacity-60">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        >
          <FaDiscord className="text-[#5865F2] group-hover:scale-110 transition-transform duration-300" size={18} />
